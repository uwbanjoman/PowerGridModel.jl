...
function PGM_create_deserializer_from_binary_buffer(handle::Ptr{Cvoid}, data_ptr::Ptr{UInt8}, size::PGM_Idx, serialization_format::PGM_Idx)
    ...
    function PGM_create_deserializer_from_null_terminated_string(handle::Ptr{Cvoid}, data_string::Cstring, serialization_format::PGM_Idx)
    ...
    function PGM_deserializer_get_dataset(handle::Ptr{Cvoid}, deserializer::Ptr{PGM_Deserializer})
        ccall((:PGM_deserializer_get_dataset, pgm_lib), Ptr{PGM_WritableDataset}, (Ptr{Cvoid}, Ptr{PGM_Deserializer}), handle, deserializer)
    end

    function PGM_deserializer_parse_to_buffer(handle::Ptr{Cvoid}, deserializer::Ptr{PGM_Deserializer})
        ccall((:PGM_deserializer_parse_to_buffer, pgm_lib), Cvoid, (Ptr{Cvoid}, Ptr{PGM_Deserializer}), handle, deserializer)
    end

    function PGM_destroy_deserializer(deserializer::Ptr{PGM_Deserializer})
    ...
    function PGM_serializer_get_to_zero_terminated_string(handle::Ptr{Cvoid}, serializer::Ptr{PGM_Serializer}, use_compact_list::PGM_Idx, indent::PGM_Idx)
    ...
    function PGM_destroy_serializer(serializer::Ptr{PGM_Serializer})
