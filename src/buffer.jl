function PGM_create_buffer(handle::Ptr{Cvoid}, component::Ptr{PGM_MetaComponent}, size::PGM_Idx)
    ccall((:PGM_create_buffer, pgm_lib), Ptr{Cvoid}, (Ptr{Cvoid}, Ptr{PGM_MetaComponent}, PGM_Idx), handle, component, size)
end

function PGM_destroy_buffer(ptr::Ptr{Cvoid})
    ccall((:PGM_destroy_buffer, pgm_lib), Cvoid, (Ptr{Cvoid},), ptr)
end

function PGM_buffer_set_nan(handle::Ptr{Cvoid}, component::Ptr{PGM_MetaComponent}, ptr::Ptr{Cvoid}, buffer_offset::PGM_Idx, size::PGM_Idx)
...
function PGM_buffer_set_value(handle::Ptr{Cvoid}, attribute::Ptr{PGM_MetaAttribute}, buffer_ptr::Ptr{Cvoid}, src_ptr::Ptr{Cvoid}, buffer_offset::PGM_Idx, size::PGM_Idx, src_stride::PGM_Idx)
...
function PGM_buffer_get_value(handle::Ptr{Cvoid}, attribute::Ptr{PGM_MetaAttribute}, buffer_ptr::Ptr{Cvoid}, dest_ptr::Ptr{Cvoid}, buffer_offset::PGM_Idx, size::PGM_Idx, src_stride::PGM_Idx)
