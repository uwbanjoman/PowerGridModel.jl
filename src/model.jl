...
function PGM_update_model(handle::Ptr{Cvoid}, model::Ptr{PGM_PowerGridModel}, update_dataset::Ptr{PGM_ConstDataset})
    ccall((:PGM_update_model, pgm_lib), Cvoid, (Ptr{Cvoid}, Ptr{PGM_PowerGridModel}, Ptr{PGM_ConstDataset}), handle, model, update_dataset)
end

function PGM_copy_model(handle::Ptr{Cvoid}, model::Ptr{PGM_PowerGridModel})
    ccall((:PGM_copy_model, pgm_lib), Ptr{PGM_PowerGridModel}, (Ptr{Cvoid}, Ptr{PGM_PowerGridModel}), handle, model)
end

function PGM_get_indexer(handle::Ptr{Cvoid}, model::Ptr{PGM_PowerGridModel}, component::Cstring, size::PGM_Idx, ids::Ptr{PGM_ID}, indexer::Ptr{PGM_Idx})
...
function PGM_calculate(handle::Ptr{Cvoid}, model::Ptr{PGM_PowerGridModel}, opt::Ptr{PGM_Options}, output_dataset::Ptr{PGM_MutableDataset}, batch_dataset::Ptr{PGM_ConstDataset})
...
function PGM_destroy_model(model::Ptr{PGM_PowerGridModel})
