...
function meta_n_datasets(handle::Ptr{Cvoid})
    ccall((:PGM_meta_n_datasets, pgm_lib), PGM_Idx, (Ptr{Cvoid},), handle)
end

function meta_get_dataset_by_idx(handle::Ptr{Cvoid}, dset_idx::PGM_Idx)
    ccall((:PGM_meta_get_dataset_by_idx, pgm_lib), Ptr{PGM_MetaDataset}, (Ptr{Cvoid}, PGM_Idx), handle, dset_idx)
end

function meta_get_dataset_by_name(handle::Ptr{Cvoid}, dataset::String)
...
function meta_dataset_name(handle::Ptr{Cvoid}, dataset::Ptr{PGM_MetaDataset})
    ccall((:PGM_meta_dataset_name, pgm_lib), Cstring, (Ptr{Cvoid}, Ptr{PGM_MetaDataset}), handle, dataset)
end

function meta_n_components(handle::Ptr{Cvoid}, dataset::Ptr{PGM_MetaDataset})
    ccall((:PGM_meta_n_components, pgm_lib), PGM_Idx, (Ptr{Cvoid}, Ptr{PGM_MetaDataset}), handle, dataset)
end

function meta_get_component_by_idx(handle::Ptr{Cvoid}, dataset::Ptr{PGM_MetaDataset}, idx::PGM_Idx)
...
function meta_get_component_by_name(handle::Ptr{Cvoid}, dataset::String, component::String)
...
function meta_component_name(handle::Ptr{Cvoid}, component::Ptr{PGM_MetaComponent})
    ccall((:PGM_meta_component_name, pgm_lib), Cstring, (Ptr{Cvoid}, Ptr{PGM_MetaComponent}), handle, component)
end

function meta_component_size(handle::Ptr{Cvoid}, component::Ptr{PGM_MetaComponent})
    ccall((:PGM_meta_component_size, pgm_lib), Csize_t, (Ptr{Cvoid}, Ptr{PGM_MetaComponent}), handle, component)
end

function meta_component_alignment(handle::Ptr{Cvoid}, component::Ptr{PGM_MetaComponent})
    ccall((:PGM_meta_component_alignment, pgm_lib), Csize_t, (Ptr{Cvoid}, Ptr{PGM_MetaComponent}), handle, component)
end

function meta_n_attributes(handle::Ptr{Cvoid}, component::Ptr{PGM_MetaComponent})
    ccall((:PGM_meta_n_attributes, pgm_lib), PGM_Idx, (Ptr{Cvoid}, Ptr{PGM_MetaComponent}), handle, component)
end

function meta_get_attribute_by_idx(handle::Ptr{Cvoid}, component::Ptr{PGM_MetaComponent}, idx::PGM_Idx)
...
function meta_get_attribute_by_name(handle::Ptr{Cvoid}, dataset::String, component::String, attribute::String)
